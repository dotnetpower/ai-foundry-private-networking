...
resource ragDocumentsContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-01-01' = {
  parent: blobService
  name: 'rag-documents'
  properties: {
    publicAccess: 'None'
...
resource ragChunksContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-01-01' = {
  parent: blobService
  name: 'rag-chunks'
  properties: {
    publicAccess: 'None'
