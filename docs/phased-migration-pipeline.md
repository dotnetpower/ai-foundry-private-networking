...
- 세밀한 네트워크 제어 가능
- Capability Host를 통해 Agent 서브넷 위임 (`Microsoft.App/environments`)
- **단점**: 구성 복잡도 높음
...
| 구성 | E2E Private | Agent 방식 | Capability Host |
|------|:-----------:|-----------|:---------------:|
| **Classic + Managed VNet** | ✅ | Compute Instance 기반 | Hub가 자동 관리 |
| **New Foundry Standard** | ✅ | 프롬프트 기반 Agent | CLI 스크립트로 구성 |
...
- **Capability Host**: CLI 스크립트로 VNet 서브넷 위임 구성
